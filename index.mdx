...
<Card title="Workflow node documentation" icon="robot" href="/workflows-documentation">
  Node catalog, triggers, actions, and board concepts live on [Workflow Docs](https://docs-workflows.pingmee.co.il/docs). See [Workflow node documentation](/workflows-documentation) for links and MCP setup.
</Card>
